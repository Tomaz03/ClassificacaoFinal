      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 border border-gray-100">
          ...
          <p className="text-gray-600 mb-6">
            Selecione dois concursos para ver os candidatos em comum.
          </p>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-16 bg-white rounded-lg shadow-md">
              <p className="text-gray-600 font-semibold text-lg">
                Nenhum candidato em comum encontrado.
              </p>
            </div>
          ) : results.length > 0 ? (
                  ...
                  {results.map((r, idx) => (
                    <tr key={idx} className="hover:bg-gray-50">
                      ...
                      <td className="p-4 text-black-600">
                        {r.contest_1.map((c, i) => (
                          <div key={i}>
                            {c.category} - Posição {c.position} ({c.situacao})
                          </div>
                        ))}
                      </td>
                      <td className="p-4 text-black-600">
            ...
            <div className="text-center py-16 bg-white rounded-lg shadow-md">
              <p className="text-gray-500">
                Selecione dois concursos e clique em "Comparar".
              </p>
            </div>
          )}
        </div>
